...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      image: "/images/proximity-to-campus.jpg",
    },
    {
    ...
    },
    {
      ...
      description:
        "Choose from short-term or long-term lease options to suit your academic schedule.",
    ...
    <section className="py-16 bg-gray-100">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-600 text-lg max-w-2xl mx-auto mb-12">
          We provide a range of services tailored to make your off-campus living
